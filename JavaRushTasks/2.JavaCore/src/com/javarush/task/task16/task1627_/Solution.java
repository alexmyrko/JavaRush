package com.javarush.task.task16.task1627_;
...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            int i = 0;
            try {
                while(!isInterrupted() && !(i == OnlineGame.steps.size())) {
                    sleep((int) 1000 / rating);
                    System.out.println(getName() + ":" + OnlineGame.steps.get(i++) + "  " + i);
                    //Add your code here - добавь код тут
                }
                OnlineGame.isWinnerFound = true;
                System.out.println("Переможець: " + getName());
