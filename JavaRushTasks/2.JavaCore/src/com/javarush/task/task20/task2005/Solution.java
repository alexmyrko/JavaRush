...
//            File your_file_name = File.createTempFile("your_file_name", null);
            File your_file_name = new File("D://file18.txt");
            ...
            outputStream.flush();
//            Human ivanenko = new Human("Ivanenko", new Asset("villa"), new Asset("plane"));
//            ivanenko.save(outputStream);
//            outputStream.flush();
...
//            System.out.println(name != null ? !name.equals(human.name) : human.name != null);
