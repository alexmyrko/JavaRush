package com.javarush.task.task20.task2004_;
...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = new File("D:/mytemp.txt");
...
//            if (staticString != null ? !staticString.equals(obj) : cws.staticString != null) return false;
            if (i != cws.i) return false;
            return j == cws.j;
        }
    }
}