...
public class Solution {
    ...
    public static Number convertNumberToOtherNumberSystem(Number number, NumberSystem expectedNumberSystem) throws NumberFormatException{
        ...
        BigInteger newNumber = new BigInteger(s, number.getNumberSystem().getNumberSystemIntValue());
        String result = newNumber.toString(expectedNumberSystem.getNumberSystemIntValue());
